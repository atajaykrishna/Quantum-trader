...
export type OrderType = 'limit' | 'market' | 'stop_limit' | 'take_profit_limit' | 'stop_market' | 'take_profit_market' | 'trailing_stop';
...
export interface PaperOrder {
  ...
  triggerDirection?: TriggerDirection; // 触发方向
  isTriggered?: boolean;   // 是否已触发
  // OCO order fields
  ocoGroupId?: string;     // OCO组ID
  ocoLinkedOrderId?: string; // 关联订单ID
  isOcoOrder?: boolean;    // 是否OCO订单
