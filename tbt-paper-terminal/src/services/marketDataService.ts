...
export const POPULAR_SYMBOLS = [
  ...
  // Indices
  'SPX500', 'NDX100', 'FTSE100', 'DAX40',
];

const CATEGORY_MAP: Record<string, string[]> = {
  'Metals': ['XAUUSD', 'XAGUSD', 'XPTUSD', 'XPDUSD'],
  'Energies': ['WTIUSD', 'BRNUSD', 'NGUSD'],
  'Major Forex': ['EURUSD', 'GBPUSD', 'USDJPY', 'AUDUSD', 'NZDUSD'],
  'Forex Crosses': ['USDCAD', 'USDCHF', 'EURGBP', 'EURJPY', 'GBPJPY'],
  'Indices': ['SPX500', 'NDX100', 'FTSE100', 'DAX40', 'CAC40'],
};
...
// Local market data server endpoint
